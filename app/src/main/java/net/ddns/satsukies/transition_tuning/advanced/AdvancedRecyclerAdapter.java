...
public class AdvancedRecyclerAdapter extends RecyclerView.Adapter<AdvancedRecyclerAdapter.MyViewHolder> {
  ...
  public AdvancedRecyclerAdapter(AppCompatActivity context, int position, List<String> list,
